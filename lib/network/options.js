...
let allOptions = {
  ...
  nodes: {
    ...
    shape: { string: ['ellipse', 'circle', 'database', 'box', 'text', 'image', 'circularImage', 'parallelogram', 'diamond', 'dot', 'star', 'triangle', 'triangleDown', 'square', 'icon', 'hexagon'] },
    shapeProperties: {
...
let configureOptions = {
  nodes: {
    ...
    shape: ['ellipse', 'box', 'circle', 'database', 'parallelogram', 'diamond', 'dot', 'square', 'star', 'text', 'triangle', 'triangleDown','hexagon'],
    shapeProperties: {
      borderDashes: false,
